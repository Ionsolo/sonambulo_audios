...
function preload() {
	sonido1 = loadSound("audios/sonambulo/1.mp3?raw=true",loaded());
	sonido2 = loadSound("audios/sonambulo/2.mp3?raw=true",loaded());
	sonido3 = loadSound("audios/sonambulo/3.mp3?raw=true",loaded());
	sonido4 = loadSound("audios/sonambulo/4.mp3?raw=true",loaded());
	sonido5 = loadSound("audios/sonambulo/5.mp3?raw=true",loaded());
	sonido6 = loadSound("audios/sonambulo/6.mp3?raw=true",loaded());
	sonido7 = loadSound("audios/sonambulo/7.mp3?raw=true",loaded());
	sonido8 = loadSound("audios/sonambulo/8.mp3?raw=true",loaded());
	sonido9 = loadSound("audios/sonambulo/9.mp3?raw=true",loaded());
	sonido10 = loadSound("audios/sonambulo/10.mp3?raw=true",loaded());
	sonido11 = loadSound("audios/sonambulo/11.mp3?raw=true",loaded());
	sonido14 = loadSound("audios/sonambulo/14.mp3?raw=true",loaded());
	sonido15 = loadSound("audios/sonambulo/15.mp3?raw=true",loaded());
	sonido16 = loadSound("audios/sonambulo/16.mp3?raw=true",loaded());
	sonido18 = loadSound("audios/sonambulo/18.mp3?raw=true",loaded());
	sonido19 = loadSound("audios/sonambulo/19.mp3?raw=true",loaded());
	sonido20 = loadSound("audios/sonambulo/20.mp3?raw=true",loaded());
	sonido21 = loadSound("audios/sonambulo/21.mp3?raw=true",loaded());
	sonido22 = loadSound("audios/sonambulo/22.mp3?raw=true",loaded());
	sonido25 = loadSound("audios/sonambulo/25.mp3?raw=true",loaded());
	sonido26 = loadSound("audios/sonambulo/26.mp3?raw=true",loaded());
	sonido27 = loadSound("audios/sonambulo/27.mp3?raw=true",loaded());
	sonido28 = loadSound("audios/sonambulo/28.mp3?raw=true",loaded());
	sonido29 = loadSound("audios/sonambulo/29.mp3?raw=true",loaded());
	sonido30 = loadSound("audios/sonambulo/30.mp3?raw=true",loaded());
	sonido31 = loadSound("audios/sonambulo/31.mp3?raw=true",loaded());
	sonido32 = loadSound("audios/sonambulo/32.mp3?raw=true",loaded());
	sonido33 = loadSound("audios/sonambulo/33.mp3?raw=true",loaded());
	sonido34 = loadSound("audios/sonambulo/34.mp3?raw=true",loaded());
	sonido35 = loadSound("audios/sonambulo/35.mp3?raw=true",loaded());
	sonido36 = loadSound("audios/sonambulo/36.mp3?raw=true",loaded());
	sonido37 = loadSound("audios/sonambulo/37.mp3?raw=true",loaded());
	sonido38 = loadSound("audios/sonambulo/38.mp3?raw=true",loaded());
	sonido39 = loadSound("audios/sonambulo/39.mp3?raw=true",loaded());
	sonido40 = loadSound("audios/sonambulo/40.mp3?raw=true",loaded());
	sonido41 = loadSound("audios/sonambulo/41.mp3?raw=true",loaded());
	sonido42 = loadSound("audios/sonambulo/42.mp3?raw=true",loaded());
	sonido44 = loadSound("audios/sonambulo/44.mp3?raw=true",loaded());
	sonido45 = loadSound("audios/sonambulo/45.mp3?raw=true",loaded());
	sonido46 = loadSound("audios/sonambulo/46.mp3?raw=true",loaded());
	sonido47 = loadSound("audios/sonambulo/47.mp3?raw=true",loaded());
	sonido48 = loadSound("audios/sonambulo/48.mp3?raw=true",loaded());
	sonido49 = loadSound("audios/sonambulo/49.mp3?raw=true",loaded());
	sonido50 = loadSound("audios/sonambulo/50.mp3?raw=true",loaded());
	sonido51 = loadSound("audios/sonambulo/51.mp3?raw=true",loaded());
	sonido52 = loadSound("audios/sonambulo/52.mp3?raw=true",loaded());
	sonido53 = loadSound("audios/sonambulo/53.mp3?raw=true",loaded());
	sonido54 = loadSound("audios/sonambulo/54.mp3?raw=true",loaded());
	sonido55 = loadSound("audios/sonambulo/55.mp3?raw=true",loaded());
	sonido56 = loadSound("audios/sonambulo/56.mp3?raw=true",loaded());
	sonido57 = loadSound("audios/sonambulo/57.mp3?raw=true",loaded());
	sonido58 = loadSound("audios/sonambulo/58.mp3?raw=true",loaded());
	sonido59 = loadSound("audios/sonambulo/59.mp3?raw=true",loaded());
	sonido60 = loadSound("audios/sonambulo/60.mp3?raw=true",loaded());
	sonido61 = loadSound("audios/sonambulo/61.mp3?raw=true",loaded());
	sonido62 = loadSound("audios/sonambulo/62.mp3?raw=true",loaded());
	sonido63 = loadSound("audios/sonambulo/63.mp3?raw=true",loaded());
	sonido64 = loadSound("audios/sonambulo/64.mp3?raw=true",loaded());
	sonido65 = loadSound("audios/sonambulo/65.mp3?raw=true",loaded());
}
